function AgregarNoticia() {
    document.getElementById("FormNoticia").addEventListener("submit", sendForm);
}
...
function validarFormulario() {
    ...
    let mensajeSelect = document.getElementById("idVistaPrevia");
    ...
    if ( inputSelect === ''){
        ...
        console.log("No selecciono la noticia de la vista previa creada anteriormente.");
        return false;
    }

    // Validación del título
    if (inputTitulo === '' || inputTitulo.length < 10 || inputTitulo.length > 40) {
